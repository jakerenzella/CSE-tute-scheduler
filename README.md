...
## Usage
- Install Clingo Python package `pip install clingo` or `pip install requirements.txt`
- Add csv's in correct location:
  - sample_data/timetable.csv
  - sample_data/preferences_castle.csv
- Run the solver `python scripts/allocate.py`
